...
export abstract class iListInventoryUsecase implements iUsecase {
    abstract exec(input: iListInventoryUsecase.Input, options ?: iUsecase.Options): Promise<iListInventoryUsecase.Output>;
}
...
export namespace iListInventoryUsecase {
    ...
    export type FiltersList = 
        BaseFilterForEntities & 
        Partial<BaseFilterForEntityItem> &
        Partial<
            BaseFilterForProductEntiry & 
            BaseFilterForServiceEntity
        >
