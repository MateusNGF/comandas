import { MissingParamError, UnexpectedParamError } from "../errors/validation.error"
...
export class ObjectManager extends Object {
  ...
  static hasKeys(requireds: Array<String>, object: Object, security: boolean = true) {
    if (typeof object != "object") throw new TypeError("segundo parametro precisa ser um objeto.")
      if (security) {
