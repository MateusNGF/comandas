...
export class OrderRepository implements iOrderRepository {
    ...
    constructor(
        private readonly Colletion : Collection<OrderEntity>
    ){}
    async create(order: OrderEntity, options?: iBaseRepository.Options): Promise<{ id: string; }> {
    ...
    findById(id: string, options?: iBaseRepository.Options): Promise<OrderEntity> {
    ...
    list(company_id: string, filters: iListEventsUsecase.Filters, options?: iBaseRepository.Options): Promise<OrderEntity[]> {
